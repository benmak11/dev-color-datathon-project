...
1,000 trending TikTok videos, and a plain English way to ask
...
1. **Posted at least 2 videos in this batch.**
   711 of the 802
   creators appear exactly once. Appearing twice is the least luck driven fact
   available.
2. **Median views of at least 50,000.** This is a
...
3. **Engagement above the batch middle.** A video's rank against all
   1,000 on likes, comments and shares per view, with the three
   ranks averaged.

That narrows 802 creators to 91 with
repeat appearances, then 74 clearing the reach
bar, then **45 who clear all three**.

### Why the three ranks are averaged

Raw engagement in this batch is 97%
...
(14 of them). **Emerging** creators have exactly two
(31 of them). The split matters because the top of the raw ranking is
...
Only 169 of 1,000 videos run
30-60s, so the format is under supplied.

Videos on original sound engage better, at
9.1% against
8.0%, and
75% of the batch already uses it.
...
ways. Verified videos take 7.6x the
median views of unverified ones
(598,300 against 78,750),
but they score 0.96x on the blended
...
45" read very differently, so the sample the rows came from
...
21 Dec 2020, and no content topic labels. Refusal is one
...
* **Two videos is thin.** Most of the shortlist qualifies on exactly two
  videos. 14 creators have three or more if you want a
  stricter cut.
